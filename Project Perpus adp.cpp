...
void inputbuku()
{
    ...
    for (c = 0; c < b; c++)
    {
        ...
        cout << "\nBuku ke - " << d << endl;
        cout << "Nomor Buku :\t";
        cin >> maksimal[a].no_buku;
        cout << "Judul Buku :\t";
        cin >> maksimal[a].judul;
        cout << "Nama Pengarang :\t";
        cin >> maksimal[a].nama_pengarang;
        cout << "Nama Penerbit :\t";
        cin >> maksimal[a].nama_penerbit;
        a++;
    }
}
...
void ubahbuku()
{
    ...
    l = k - 1;
    cout << "Nomor Buku :\t";
    cin >> maksimal[1].no_buku;
    cout << "Judul Buku :\t";
    cin >> maksimal[1].judul;
    cout << "Nama Pengarang :\t";
    cin >> maksimal[1].nama_pengarang;
    cout << "Nama Penerbit :\t";
    cin >> maksimal[1].nama_penerbit;
    lihatbuku();
}
